...
resource "aws_iam_policy" "lambda" {
  name        = "CWocheAWSLambdaBasicExecutionRolePolicy"
  path        = "/"
  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        {
          "Action": "iam:PassRole",
          "Resource": ["arn:aws:iam::649165755582:role/EMR_DefaultRole",
                       "arn:aws:iam::649165755582:role/EMR_EC2_DefaultRole"],
          "Effect": "Allow"
        }
    ]
}
