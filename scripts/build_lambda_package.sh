...
FILE_REQUIREMENTS=../code/lambda_requirements.txt
...
# LAMBDA_FUNCTION=../../code/lambda_function.py
LAMBDA_FUNCTION=../../code/lambda_function_desafio.py
...
then
	...
	echo "Arquivo compactado com sucesso em $PWD"
	echo "============================================="
fi
